...
public class EmailServices {
    ...
    public void sendTransactionHistoryEmail(String recipientEmail, List<TransationStatment> transactionHistoryList) {
        try {
            ...
            for (TransationStatment history : transactionHistoryList) {
